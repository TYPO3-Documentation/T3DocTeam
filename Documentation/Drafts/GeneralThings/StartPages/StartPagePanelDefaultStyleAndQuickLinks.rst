...
===============================================
Startpage : panel-default style and quick links
===============================================
...
- :ref:`Formatting with reST <h2document:Formatting-with-reST>`
- :ref:`h2document:how-to-start-docs-extension`
- `T3SphinxThemeRtd DemoDocs <https://docs.typo3.org/typo3cms/drafts/github/TYPO3-Documentation/t3SphinxThemeRtdDemoDocs/Index.html>`__
...
You will find information about how to format the documenation in reST and some best practices in this guide.
...
* Look at :ref:`how-to-start-docs-extension`

*For TYPO3 core developers:*

* Read :ref:`t3contribute:Bugfixing-Adding-documentation` to learn about how to add
