...
* `Core API <https://docs.typo3.org/typo3cms/CoreApiReference/#>`__

**Problem:**

* contains no information about what manual is about
* contains redundant metadata that is already on footer / left panel (e.g. Version,
